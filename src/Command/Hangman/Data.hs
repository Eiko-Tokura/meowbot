...
module Command.Hangman.Data where
...
wordBlacklist = S.fromList [ "git", "bonaparte", "walter", "jane", "john", "maurice" ]

wordFreqMap :: M.Map Text Int
wordFreqMap = M.fromList $ zip (V.toList wordLib) (U.toList wordFreq)

wordLib :: V.Vector Text
wordLib = V.fromList
  [ "the", "and", "that", "was", "his", "with", "for", "had", "you", "not", "her", "which", "have", "from", "this", "him", "but", "all", "she", "they"
...
wordFreq :: U.Vector Int
wordFreq = U.fromList
  [ 56271872, 29944184, 11073318, 10078245, 8799755, 7725512, 7097981, 6139336, 6048903, 5741803, 5202501, 4580906, 4346500, 4108111, 4015425, 3971997, 3894211, 3703342, 3415846, 3340398
