...
fromFontStyle FontSlantItalic  FontWeightBold   = notoSansCjkBoldItalic
fromFontStyle FontSlantOblique FontWeightBold   = notoSansCjkBoldItalic
fromFontStyle FontSlantNormal  FontWeightBold   = notoSansCjkBold
fromFontStyle FontSlantItalic  FontWeightNormal = notoSansCjkItalic
fromFontStyle FontSlantOblique FontWeightNormal = notoSansCjkItalic
fromFontStyle _                _                = notoSansCjkRegular
...
notoSansCjkRegular :: Font
notoSansCjkRegular = staticFont "NotoSansSC-Regular.ttf"

notoSansCjkBold :: Font
notoSansCjkBold = staticFont "NotoSansSC-Bold.ttf"

notoSansCjkItalic :: Font
notoSansCjkItalic = staticFont "NotoSansSC-Regular.ttf"

notoSansCjkBoldItalic :: Font
notoSansCjkBoldItalic = staticFont "NotoSansSC-Bold.ttf"
